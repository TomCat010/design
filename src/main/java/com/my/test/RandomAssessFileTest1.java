...
public class RandomAssessFileTest1 {
    ...
    /*
    通常来说，
    PrintWriter用于编写格式化文本，
    FileOutputStream用于写二进制数据，
    DataOutputStream用于写基本数据类型，
    RandomAccessFile用于在特定位置对文件进行操作，
    FileChannel对于大型文件的操作更加高效。
    虽然这些API都可以提供很多功能，
    但是根据不同的使用场景选择合适的方案会更加便利。
    */
